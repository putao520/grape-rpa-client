...
describe("api/editor/theme", function () {
    ...
    it("applies the default theme", async function () {
        ...
        context.page.should.have.a.property("title", "GrapeRPA");
    ...
    it("picks up custom theme", async function () {
        theme.init({
            editorTheme: {
                ...
                palette: {
                    editable: false,
                    catalogues: ['https://rpa.putao282.com/store/database.json'],
        ...
        context.header.should.have.a.property("url", "http://rpa.putao282.com");
