...
table.red-ui-info-table tr:not(.blank):not(.jsoneditor):not(.jsoneditor-expandable):not(.jsoneditor-expanded):not(.faked) {
...
table.red-ui-info-table tr:not(.blank):not(.faked) td:first-child:not(.jsoneditor):not(.faked){
...
table.red-ui-info-table tr:not(.blank):not(.faked) td:last-child:not(.jsoneditor):not(.faked){
    padding: 3px 3px 3px 6px;
    color: var(--red-ui-primary-text-color);
    overflow-y: hidden;
}
...
.red-ui-help {
    ...
    table th:not(.jsoneditor):not(.faked),
    table td:not(.jsoneditor):not(.faked) {
        padding: 6px 8px;
    }
    table tbody tr:nth-of-type(even):not(.jsoneditor):not(.faked) {
