...
// Heading text
    ...
    --red-ui-debug-button-color: #{$deploy-button-color};
    --red-ui-debug-button-color-active: #{$deploy-button-color-active};
    --red-ui-debug-button-color-disabled: #{$deploy-button-color-disabled};
    --red-ui-debug-button-background: #{$deploy-button-background};
    --red-ui-debug-button-background-hover: #{$deploy-button-background-hover};
    --red-ui-debug-button-background-active: #{$deploy-button-background-active};
    --red-ui-debug-button-background-disabled: #{$deploy-button-background-disabled};
    --red-ui-debug-button-background-disabled-hover: #{$deploy-button-background-disabled-hover};
