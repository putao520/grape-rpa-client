...
#red-ui-header {
    ...
    #red-ui-header-button-debug,#red-ui-header-button-debug-step-over{
        outline: none;
        padding: 4px 12px;
        &:hover {
            background: var(--red-ui-debug-button-background-hover);
        }
        &:active {
            background: var(--red-ui-debug-button-background);
        }
    }
    .red-ui-debug-button-group{
        #red-ui-header-button-debug-options {
            outline: none;
            color: var(--red-ui-debug-button-color-active);
        }
        #red-ui-header-button-debug-options:hover {
            background: var(--red-ui-debug-button-background-hover);
        }
        #red-ui-header-button-debug-options:active {
            background: var(--red-ui-debug-button-background);
        }
        .red-ui-debug-button-content>img {
            margin-right: 8px;
        }
        .open {
            #red-ui-header-button-debug-options {
    ...
    /* Debug menu customisations */
    ul#red-ui-header-button-debug-options-submenu {
        width: 300px !important;
        li a {
            padding: 10px 30px;
            color: var(--red-ui-header-menu-heading-color);
