...
RED.sidebar.context = (function() {
    ...
    function init() {
        ...
        $('<tr class="red-ui-help-info-row red-ui-search-empty blank" colspan="2"><td data-i18n="sidebar.context.refrsh"></td></tr>').appendTo(globalSection.table).i18n();
    ...
    function updateNode(node,force) {
        ...
        if (force || nodeAutoRefresh.prop("checked")) {
            ...
            if (node) {
                $('<tr class="red-ui-help-info-row red-ui-search-empty blank" colspan="2"><td data-i18n="sidebar.context.refrsh"></td></tr>').appendTo(nodeSection.table).i18n();
            } else {
    ...
    function updateFlow(flow, force) {
        ...
        if (force || flowAutoRefresh.prop("checked")) {
            ...
            $('<tr class="red-ui-help-info-row red-ui-search-empty blank" colspan="2"><td data-i18n="sidebar.context.refrsh"></td></tr>').appendTo(flowSection.table).i18n();
