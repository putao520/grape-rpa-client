            ...
            try {
                ...
                try {
                    ...
                    if (process.env.HOMEPATH) {
                        fs.statSync(path.join(process.env.HOMEPATH,".grape-rpa",".config.json"));
                        storageBaseDir = path.join(process.env.HOMEPATH, ".grape-rpa", base);
                    }
                } catch(err) {
                }
                if (!storageBaseDir) {
                    storageBaseDir = path.join(process.env.HOME || process.env.USERPROFILE || process.env.HOMEPATH || process.env.NODE_RED_HOME,".grape-rpa", base);
                }
            }
        }
    }else{
