...
function handleDebugEvent(event) {
    runtime.log.trace("debug event: "+JSON.stringify(event));
    publish("debug/"+event.id,event.payload||{},event.retain);
}
...
var api = module.exports = {
    init: function(_runtime) {
        ...
        events.removeListener("debug-event",handleDebugEvent);
        events.on("debug-event",handleDebugEvent);
