...
function init(_self, _runtime){
    ...
    // 暂停
    httpAdmin.post("/inject/event/pause", api.auth.needsPermission("inject.write"), function(req,res) {
            try {
    ...
    // 停止
    httpAdmin.post("/inject/event/stop", api.auth.needsPermission("inject.write"), function(req,res) {
        try {
            const body = buildContext(req, req.params.id, true)
