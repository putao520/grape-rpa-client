...
const operatorFormModel = {
    "click": (page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            page.locator(target).click().then(() => {
                resolve()
            }).catch(e => {
                reject(e)
            })
    ...
    "press":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            ...
            msg += config.keyState;
            page.locator(target).press(target, msg, {delay: 100}).then(()=> {
                resolve()
            }).catch(e=>{
                reject(e)
            })
    ...
    */
    "select-color":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            page.locator(target).fill(target, config.color).then(() => {
                resolve()
            }).catch(e => {
                reject(e)
            })
    ...
    "select-date":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            ...
            page.locator(target).fill(target, date).then(() => {
                resolve()
            }).catch(e => {
                reject(e)
            })
    ...
    "select-file":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            if( config.file.length > 0 ){
                page.locator(target).setInputFiles(target, config.file).then(() => {
                    resolve()
                }).catch(e => {
                    reject(e)
                })
    ...
    "select-file-multiple":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            ...
            if( config.files.length > 0 && fileArray.length > 0 ) {
                page.locator(target).setInputFiles(target, fileArray).then(() => {
                    resolve()
                }).catch(e => {
                    reject(e)
                })
    ...
    "fill-number":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            page.locator(target).fill(target, config.number).then(() => {
                resolve()
            }).catch(e => {
                reject(e)
            })
    ...
    "fill-number-range":(page, target, config) =>{
        return new Promise( (resolve,reject)=> {
            // 根据 偏移值 调整数字
            page.locator(target).fill(target, config.rangeNumber).then(() => {
                resolve()
            }).catch(e => {
                reject(e)
            })
