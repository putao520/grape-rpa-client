<script type="text/javascript">
  RED.nodes.registerType('dom-operator', {
    ...
    oneditprepare: function () {
      const _self = this
      InitNamed("#node-input-selectorName", this.selectorName, "browser.label.dom")
...
<script type="text/html" data-template-name="dom-operator">
  ...
  <!-- 隐藏的iframe定位信息 -->
  <div class="form-row" id="div-input-selectedIframe" style="display: none">
    <input type="hidden" id="node-input-selectedIframe">
  </div>
  <!-- 元素名称 -->
  <div class="form-row">
  ...
  <div class="form-row" id="div-input-fillMode" style="display: none">
    ...
    <input style="width:20px; vertical-align:baseline; margin-right:5px;" type="checkbox" id="node-input-fillMode">
    <label style="width:auto; margin-top:7px;" for="node-input-fillMode">
      <span data-i18n="browser.mode.yes"></span>
    </label><br/>
  </div>
  <!-- 按键区域 -->
