...
const {getSelector,getFramePage} = require("./lib/dom-common")
...
module.exports = function(RED) {
    ...
    function doReadRouterBatch(page, target, config) {
		// page 处理 iframe 的时候，需要用到 frame
		const selectedIframe = config.selectedIframe || '[]'
		page = getFramePage(page, JSON.parse(selectedIframe))
		// 操作组
