...
<script type="text/x-red" data-help-name="catch">
    ...
    <dl class="message-properties">
        ...
        <dd>引发错误的组件的名称。（如果已设置）</dd>
    </dl>
    <h3>详细</h3>
    <p>如果组件在处理消息时抛出错误，则流程通常会停止。该组件可用于捕获那些错误并通过专用流程进行处理。</p>
    <p>默认情况下，该组件将捕获同一标签页上任何组件抛出的错误。或者，它可以针对特定组件，或配置为仅捕获另一个“目标”捕获组件尚未捕获的错误。</p>
    <p>当错误发生时，所有匹配的catch组件都会收到错误消息。</p>
    <p>如果在子流中发送了错误，则该错误将由子流中的任意捕获组件处理。如果子流中不存在捕获组件，则那错误将被传播到子流实例所在的标签页。</p>
