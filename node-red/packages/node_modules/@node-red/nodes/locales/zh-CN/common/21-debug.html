...
<script type="text/x-red" data-help-name="debug">
    ...
    <p>对任意条消息，调试侧边栏还会显示接收消息的时间，发送消息的组件以及消息类型等信息。单击源组件ID将在工作区中显示该组件。</p>
    <p>组件上的按钮可用于启用或禁用其输出。建议禁用或删除所有未使用的调试组件。</p>
    <p>还可以通过配置组件，将所有消息发送到运行时的日志，或将简短的数据（32个字符内）在调试组件下的状态文本上显示。</p>
</script>
