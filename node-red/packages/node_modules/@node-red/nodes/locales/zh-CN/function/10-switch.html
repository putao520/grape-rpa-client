...
<script type="text/x-red" data-help-name="switch">
    ...
    <h4>处理消息序列</h4>
    <p>默认情况下，组件不会修改<code>msg.parts</code>属性。</p>
    <p>可以启用<b>重建消息序列</b>选项来为每条匹配的规则生成新的消息序列。在这种模式下，组件将在发送新序列之前对整个传入序列进行缓存。运行时的设定<code>nodeMessageBufferMaxLength</code>可以用来限制可缓存的消息数目。</p>
</script>
