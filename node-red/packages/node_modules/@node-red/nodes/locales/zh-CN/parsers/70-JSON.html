...
<script type="text/x-red" data-help-name="json">
    ...
    <dl class="message-properties">
        ...
        <dd>可选的JSON Schema对象用于验证有效负载。在将<code>msg</code>发送到下一个组件之前，将删除该属性。</dd>
    </dl>
    <h3>Outputs</h3>
    <dl class="message-properties">
        <dt>payload<span class="property-type">object | 字符串</span></dt>
        ...
        <dd>如果JSON模式验证失败，则catch组件将具有包含错误数组的<code>schemaError</code>属性。</dd>
    </dl>
    <h3>详细</h3>
    <p>默认的转换目标是<code>msg.payload</code>，但是也可以转换消息的其它属性。</p>
    <p>您可以将其设置为仅执行特定的转换，而不是自动选择双向转换。例如，即使对<code>HTTP In</code>组件的请求未正确设置‘content-type’，也可以使用它来确保JSON组件的转换结果是JavaScript对象</p>
